...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        if (isset($_POST['confirm']) && $_POST['confirm'] === 'oui') {
            $result = $taskService->deleteTask($task_id);
    ...
    <div class="container">
        ...
        <div class="alert-card">
            ...
            <?php else: ?>
                ...
                <h2 class="alert-title">Supprimer la Tâche</h2>
                ...
                <div class="task-info">
                    <div><strong>ID:</strong> <?php echo $task->getId(); ?></div>
                    <div><strong>Titre:</strong> <?php echo htmlspecialchars($task->getTitre()); ?></div>
                    <div><strong>Sprint:</strong> <?php echo htmlspecialchars($sprint->getTitre()); ?></div>
                    <div><strong>Priorité:</strong> <?php echo $task->getPrioriteText(); ?></div>
                    <div><strong>Statut:</strong> <?php echo $task->getStatutText(); ?></div>
                    <div><strong>Échéance:</strong> <?php echo $task->getDateEcheance() ?: 'Non définie'; ?></div>
                    <div><strong>Créée le:</strong> <?php echo $task->getDateCreation(); ?></div>
                </div>
                
                <div class="warning-box">
                    <i class="fas fa-exclamation-circle"></i>
                    <strong>Attention:</strong> Tous les assignations et données associées à cette tâche seront supprimées.
                </div>
