    ...
    <div class="container">
        <div class="form-card">
            <h2 class="form-title">
                ...
                Modifier Projet #<?php echo $projet->getId(); ?>
            </h2>
            ...
            <form method="POST" action="">
                <div class="form-group">
                    ...
                    <input type="text" 
                           name="titre" 
                           class="form-control" 
                           value="<?php echo htmlspecialchars($projet->getTitre()); ?>"
                           required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" 
                              class="form-control"><?php echo htmlspecialchars($projet->getDescription()); ?></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" 
                           name="chef_id" 
                           class="form-control" 
                           value="<?php echo $projet->getChefId(); ?>">
                </div>
